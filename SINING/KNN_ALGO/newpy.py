#!C:\Users\mieann\AppData\Local\Programs\Python\Python311\python.exe
print("Content-Type: text/php\n\n")
import warnings

import sys
sys.path.append("C:\\Users\\mieann\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site-packages")
import pymysql
import json
import codecs
import io
