...
$approval = mysqli_query($conn, "SELECT a.product_id, a.seller_id, a.product_name, a.product_price, a.product_quantity, b.artistName, a.product_status
...
<div id="seller-profile-con">
  ...
  <button class="seller-btn tablinks" onclick="openCity(event, 'gcash-payment')"><h4>Gcash Payment</h4><img src="assets/img/credit-card.png"></button>
...
<div id="gcash-payment" class="tabcontent">
    <iframe src="gcash_payment.php" frameborder="0" width="100%" height="100%"></iframe>
</div>
