...
<div class="row headingText">
         ...
         echo "<a href='payment_method.php' class='btn' onclick='if(!validateCheckboxes()) { return false; }'>Checkout</a>";
         }
         ?> 
         </div>
</section>
...
function validateCheckboxes() {
  ...
  if (!isChecked) {
   //  swal("Alert", "Select at least one artwork before proceeding to checkout.", "warning");
   //  return false;
  }
  return true;
}
